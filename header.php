...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>?v=1.4" type="text/css" media="screen" />
	...
	<div class="header-fill">
		<div class="container_8 header">
			...
			<div class="grid_5 pre-menu">
				<?php wp_nav_menu(array('menu' => 'primary', 'menu_id' => 'menu-header', 'theme_location' => 'primary', 'depth' => 2)); ?> 
			</div>
		</div>
	</div>
